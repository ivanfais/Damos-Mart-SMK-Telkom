...
export class AdminReportsService {
  ...
  async getSalesReport(period: 'daily' | 'weekly' | 'monthly') {
    ...
    const salesChartMap = new Map<string, { dateStr: string; revenue: number; volume: number }>();
    ...
    const productStatsMap = new Map<string, { id: string; name: string; categoryName: string; quantitySold: number; totalRevenue: number }>();
    ...
    const categoryStatsMap = new Map<string, { categoryName: string; revenue: number; quantitySold: number }>();
