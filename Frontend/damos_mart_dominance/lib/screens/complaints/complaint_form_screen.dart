...
class _ComplaintFormScreenState extends State<ComplaintFormScreen> {
  ...
  bool get _isFormReady =>
      _selectedIssue != null && _messageController.text.trim().isNotEmpty;
  ...
  String _buildSubject() {
    final issueLabel = _selectedIssue!.label;

    if (widget.isProductComplaint) {
      return '${widget.selectedProduct!.productName} — $issueLabel';
    }
    if (widget.serviceIssue != null) {
      return '${widget.serviceIssue!.title} — $issueLabel';
    }
    return issueLabel;
  }
  ...
  Future<void> _submit() async {
    ...
    try {
      final result = await _repository.createComplaint(
        ...
        description: message,
        category: _selectedIssue!.apiCategory,
