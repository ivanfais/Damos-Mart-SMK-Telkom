...
class _Ds {
  static const Color primary = Color(0xFF018D1A);
  static const Color textPrimary = Color(0xFF111111);
  static const Color textSecondary = Color(0xFF555555);
  static const Color border = Color(0xFFCCCCCC);
  static const Color borderLight = Color(0xFFE0E0E0);
  static const Color bgGrey = Color(0xFFF0F0F0);
  static const Color bgLight = Color(0xFFDCF5E0);
      ...
      children: [
        Text(label,
            style: const TextStyle(
                fontFamily: 'Poppins', fontSize: 12, color: _Ds.textSecondary)),
        Text(value,
            style: TextStyle(
                fontFamily: 'Poppins',
                fontSize: 12,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(CurrencyFormatter.format(_displayPrice(product)),
                                style: const TextStyle(
                                    fontFamily: 'Poppins',
                                    fontSize: 15,
                                    fontWeight: FontWeight.w700,
                        ...
                        // Preorder info — tabel rapi
                        const Text('Informasi Pre-Order',
                            style: TextStyle(
                                fontFamily: 'Poppins',
                                fontSize: 14,
                                fontWeight: FontWeight.w700,
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              _infoRow('Sesi Pemesanan', info.session),
                              const SizedBox(height: 8),
                              const Divider(color: Color(0xFFB2DFB8), height: 1),
                              const SizedBox(height: 8),
                              _infoRow('Estimasi Produksi', info.production),
                              const SizedBox(height: 8),
                              const Divider(color: Color(0xFFB2DFB8), height: 1),
                              const SizedBox(height: 8),
                              _infoRow('Estimasi Tiba', info.arrival, bold: true),
                            ],
                          ),
                        ),
                        const SizedBox(height: 16),
