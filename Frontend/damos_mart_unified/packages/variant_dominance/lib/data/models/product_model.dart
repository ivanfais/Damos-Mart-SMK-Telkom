...
import 'package:disc_core/product_image_resolver.dart';
...
class ProductModel extends Equatable {
  ...
  /// Best image for the current DISC theme and optional selected size/varian.
  String? displayImageUrl({ProductVariantModel? selectedVariant}) {
    return ProductImageResolver.resolve(
      productImageUrl: imageUrl,
      variants: variants
          .map((v) => (variantName: v.variantName, imageUrl: v.imageUrl))
          .toList(),
      selectedVariant: selectedVariant != null
          ...
          : null,
      discVariant: core.DiscVariant.values.byName(DiscAppConfig.hostVariant.name),
    );
  }
